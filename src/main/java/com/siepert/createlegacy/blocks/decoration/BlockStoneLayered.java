...
public class BlockStoneLayered extends Block implements IHasModel, IMetaName {
    ...
    private static final String name = "stone_layered";
    ...
    public void registerModels() {
        for (int i = 0; i < EnumHandler.DecoStoneEnumType.values().length; i++) {
            ...
            CreateLegacy.proxy.registerVariantRenderer(Item.getItemFromBlock(this),
                    i, "stone/stone_layered_" + s, "inventory");
