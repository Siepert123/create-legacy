    ...
    public static void init() {
                ...
                if (doesOreDictNameExist(nugget(metal))) {
                    for (ItemStack stack : OreDictionary.getOres(crushed(metal))) {
                        ...
                        WashingRecipes.addRecipe(stack,
                                SimpleTuple.washingEntry(nuggets)
                        );
                    }
                }
            }
        ...
        for (ItemStack input : OreDictionary.getOres(crushed("iron"))) {
            WashingRecipes.addRecipe(input, true,
                    SimpleTuple.washingEntry(new ItemStack(Items.IRON_NUGGET, 9)),
                    SimpleTuple.washingEntry(new ItemStack(Items.REDSTONE), 0.12f)
            );
        }
        for (ItemStack input : OreDictionary.getOres(crushed("gold"))) {
            WashingRecipes.addRecipe(input, true,
                    SimpleTuple.washingEntry(new ItemStack(Items.GOLD_NUGGET, 9)),
                    SimpleTuple.washingEntry(new ItemStack(Items.QUARTZ), 0.50f)
            );
        }
        for (ItemStack input : OreDictionary.getOres(crushed("copper"))) {
            ...
            WashingRecipes.addRecipe(input, true,
                    SimpleTuple.washingEntry(nuggets),
                    SimpleTuple.washingEntry(new ItemStack(Items.CLAY_BALL), 0.50f)
            );
        }
        for (ItemStack input : OreDictionary.getOres(crushed("zinc"))) {
            ...
            WashingRecipes.addRecipe(input, true,
                    SimpleTuple.washingEntry(nuggets),
                    SimpleTuple.washingEntry(new ItemStack(Items.GUNPOWDER), 0.25f)
            );
        }

        for (ItemStack stack : OreDictionary.getOres("gravel")) {
            WashingRecipes.addRecipe(stack,
                    SimpleTuple.washingEntry(new ItemStack(Items.FLINT, 1), 0.25f),
                    SimpleTuple.washingEntry(new ItemStack(Items.IRON_NUGGET, 1), 0.12f)
            );
        }
        for (ItemStack stack : OreDictionary.getOres("sand")) {
            if (stack.getItem() == Item.getItemFromBlock(Blocks.SAND) && stack.getMetadata() == 1) {
                WashingRecipes.addRecipe(stack,
                        SimpleTuple.washingEntry(new ItemStack(Items.GOLD_NUGGET, 3), 0.12f),
                        SimpleTuple.washingEntry(new ItemStack(Blocks.DEADBUSH, 1), 0.05f)
                );
            } else {
                WashingRecipes.addRecipe(stack,
                        SimpleTuple.washingEntry(new ItemStack(Items.CLAY_BALL, 1), 0.25f)
                );
            }
        }
        ...
        for (int i = 0; i < 16; i++) {
            if (i != 0) {
                WashingRecipes.addRecipe(new ItemStack(Blocks.WOOL, 1, i),
                        SimpleTuple.washingEntry(new ItemStack(Blocks.WOOL, 1, 0))
                );
            }
            WashingRecipes.addRecipe(new ItemStack(Blocks.STAINED_GLASS, 1, i),
                    SimpleTuple.washingEntry(new ItemStack(Blocks.GLASS, 1))
            );
            WashingRecipes.addRecipe(new ItemStack(Blocks.STAINED_GLASS_PANE, 1, i),
                    SimpleTuple.washingEntry(new ItemStack(Blocks.GLASS_PANE, 1))
            );
            WashingRecipes.addRecipe(new ItemStack(Blocks.CONCRETE_POWDER, 1, i),
                    SimpleTuple.washingEntry(new ItemStack(Blocks.CONCRETE, 1, i))
            );
        }
